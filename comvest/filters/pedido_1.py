...
filteredIDs_comvest = set(filter_db.filterby_course(COMVEST_SAMPLE, courses=[3,42], db='comvest'))

# Filtragem de cursos na DAC
filteredIDs_dac = set(filter_db.filterby_course(DAC_VA_SAMPLE, courses=[3,42], db='dac'))
