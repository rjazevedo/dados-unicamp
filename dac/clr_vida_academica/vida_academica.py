...
def generate_clean_data():
    ...
    str_to_upper_ascii(vida_academica, ['curso_nome', 'tipo_ingresso', 'motivo_saida', 'cota_d', 'cota_tipo', 'cota_descricao'])
    ...
    padronize_int_miss(vida_academica, ['ano_saida'])
    print(vida_academica.dtypes)
