...
def get_columns_info_rais():
    return {
        ...
        'ind_sindical': {
            ...
            'tipo_limpo': 'Int64',
            'campo': {
                # So 2017 -- coluna some do layout a partir de 2018 (confirmado no
                # cabecalho bruto real: existe em rais-novo/2017/AC2017ID.txt col 80,
                # ausente em RAIS_VINC_ID_CENTRO_OESTE.txt de 2018 e 2022). O dict
                # original (origin/giovani) tinha (2017, 2022), o que e inofensivo em
                # termos de dado (rename_columns() ja cria NaN quando a coluna bruta
                # nao existe no ano), mas o periodo correto e so 2017.
