...
def set_global_variables():
    file = '/home/larissa/scripts/clean_module/codes/municipios.csv'
    dtype = {'municipio': 'object'}
    global municipios
    municipios = clean_module.file.read_csv(file, dtype, squeeze=True)

    file = '/home/larissa/scripts/clean_module/codes/cnae95.csv'
    dtype = {'cnae95': 'object'}
    global cnae95
    cnae95 = clean_module.file.read_csv(file, dtype, squeeze=True)

    file = '/home/larissa/scripts/clean_module/codes/cbo94.csv'
    dtype = {'cbo94': 'object'}
    global cbo94
    cbo94 = clean_module.file.read_csv(file, dtype, squeeze=True)

    file = '/home/larissa/scripts/clean_module/codes/nat_juridica.csv'
    dtype = {'nat_juridica': 'object'}
    global nat_juridica
    nat_juridica = clean_module.file.read_csv(file, dtype, squeeze=True)

    file = '/home/larissa/scripts/clean_module/codes/cbo02.csv'
    dtype = {'cbo02': 'object'}
    global cbo02
    cbo02 = clean_module.file.read_csv(file, dtype, squeeze=True)

    file = '/home/larissa/scripts/clean_module/codes/cnae20classe.csv'
    dtype = {'cnae20classe': 'object'}
    global cnae20classe
    cnae20classe = clean_module.file.read_csv(file, dtype, squeeze=True)

    file = '/home/larissa/scripts/clean_module/codes/cnae20subclasse.csv'
    dtype = {'cnae20subclasse': 'object'}
    global cnae20subclasse
    cnae20subclasse = clean_module.file.read_csv(file, dtype, squeeze=True)
...
def check_vinculo_tipo(value):
    values = [
        10, 15, 20, 25, 30, 31, 35, 40, 50, 55,
        60, 65, 70, 75, 80, 90, 95, 96, 97
    ]
...
def check_deslig_motivo(value):
    values = [
        ...
        33, 34, 40, 50, 60, 62, 63, 64, 70, 71,
        72, 73, 74, 75, 76, 78, 79, 80, 90
    ]
    return value in values
